...
/**
 * The CopyOutputFormat is the Hadoop OutputFormat used in DistCp. It sets up
 * the Job's Configuration (in the Job-Context) with the settings for the
 * work-directory, final commit-directory, etc. It also sets the right
 * output-committer.
 *
 * @param <K>
 * @param <V>
...
public class CopyOutputFormat<K, V> extends TextOutputFormat<K, V> {
     ...
     *
     * @param job The Job on whose configuration the working-directory is to be
     * set.
