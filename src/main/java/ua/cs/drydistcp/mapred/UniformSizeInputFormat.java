...
/**
 * UniformSizeInputFormat extends the InputFormat class, to produce input-splits
 * for DistCp. It looks at the copy-listing and groups the contents into
 * input-splits such that the total-number of bytes to be copied for each input
 * split is uniform.
 */
public class UniformSizeInputFormat
    ...
    /**
     * Implementation of InputFormat::getSplits(). Returns a list of
     * InputSplits, such that the number of bytes to be copied for all the
     * splits are approximately equal.
     *
