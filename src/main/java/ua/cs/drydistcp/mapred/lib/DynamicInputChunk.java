...
import ua.cs.drydistcp.mapred.lib.DynamicInputChunkContext;

/**
 * The DynamicInputChunk represents a single chunk of work, when used in
 * conjunction with the DynamicInputFormat and the DynamicRecordReader. The
 * records in the DynamicInputFormat's input-file are split across various
 * DynamicInputChunks. Each one is claimed and processed in an iteration of a
 * dynamic-mapper. When a DynamicInputChunk has been exhausted, the faster
