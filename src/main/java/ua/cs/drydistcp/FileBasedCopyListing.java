...
/**
 * FileBasedCopyListing implements the CopyListing interface, to create the
 * copy-listing for DistCp, by iterating over all source paths mentioned in a
...
public class FileBasedCopyListing extends CopyListing {
    ...
    /**
     * Implementation of CopyListing::buildListing(). Iterates over all source
     * paths mentioned in the input-file.
     *
