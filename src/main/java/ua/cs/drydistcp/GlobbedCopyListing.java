...
public class GlobbedCopyListing extends CopyListing {
    ...
    /**
     * Implementation of CopyListing::buildListing(). Creates the copy listing
     * by "globbing" all source-paths.
     *
     * @param pathToListingFile The location at which the copy-listing file is
     * to be created.
