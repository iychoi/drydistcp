...
/**
 * The OptionsParser parses out the command-line options passed to DistCp, and
 * interprets those specific to DistCp, to create an Options object.
 */
public class OptionsParser {
    ...
    /**
     * The parse method parses the command-line options, and creates a
     * corresponding Options object.
     *
     * @param args Command-line arguments (excluding the options consumed by the
    ...
    public static DistCpOptions parse(String args[]) throws IllegalArgumentException {
       ...
       If both are present, throw exception and bail */
        ...
        if (command.hasOption(DistCpOptionSwitch.DRYRUN.getSwitch())) {
